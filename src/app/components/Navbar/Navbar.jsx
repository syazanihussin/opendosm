       ...
       <nav className=" bg-gray-900 border-b border-gray-200">
          ...
          <span className="text-indigo-600 text-xl font-bold">{title}</span>
            ...
            <div className="hidden sm:flex sm:items-center sm:gap-2">
              <a href="#" className="px-3 py-2 text-sm hover:bg-gray-100 hover:text-black rounded-md">Home</a>
              <a href="#" className="px-3 py-2 text-sm hover:bg-gray-100  hover:text-black rounded-md">Features</a>
              <a href="#" className="px-3 py-2 text-sm hover:bg-gray-100   hover:text-black rounded-md">Pricing</a>
              <a href="#" className="px-3 py-2 text-sm hover:bg-gray-100  hover:text-black  rounded-md">Docs</a>
              </div>
          </div>
          ...
          {/* Right section */}
          <div className="flex items-center gap-4">
          <a href="#" className="hidden sm:inline-flex px-4 py-2 bg-indigo-600 text-white rounded-md text-sm hover:bg-indigo-500">
          Get started
          </a>
          ...
          <a href="#" className="block w-full text-center px-4 py-2 bg-indigo-600 text-white rounded-md">
          Get started
          </a>
          </div>
          </div>
